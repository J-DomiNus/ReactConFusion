            ...
            <Fragment>
                <Navbar dark expand='md'>
                    <div className='container'>
                        <NavbarToggler onClick={() => this.toggleNav()} /> {/* NavbarToggler is shown for extra small to md */}
                        <NavbarBrand className='mr-auto' href='/'>
                            <img src='assets/images/logo.png' height='30' width='41'
                                alt='Ristorante Con Fusion' />
                        </NavbarBrand>
                        <Collapse isOpen={this.state.isNavOpen} navbar> {/* Collapse works between extra sm to md */}
                        <Nav navbar>
                            <NavItem>
                        ...
                        <div className='row row-header'>
                            <div className='col-12 col-sm-6'>
                                ...
                                <p>We take inspiration from the World's best cuisines, 
                                    and create a unique fusion experience. Our lipsmaking 
                                    creation will tickle your culinary senses!
                                </p>
                            </div>
                        </div>
                    </div>
